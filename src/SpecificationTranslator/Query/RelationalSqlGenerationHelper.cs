...
namespace SpecificationTranslator.Query
{
    ...
    public class RelationalSqlGenerationHelper : ISqlGenerationHelper
    {
        ...
        protected virtual void GenerateLiteralValue([NotNull] StringBuilder builder, [NotNull] Enum value)
            => builder.AppendFormat(CultureInfo.InvariantCulture, "{0:d}", value);
        ...
        /// <param name="value">The literal value.</param>
        /// <returns> The generated string. </returns>
        public virtual string GenerateLiteralValue(DateTime value)
        ...
        protected virtual string GenerateLiteralValue([NotNull] string value)
            => $"'{EscapeLiteral(value)}'"; // Interpolation okay; strings
        ...
        public virtual string GenerateLiteral(object value)
        {
            if (value != null)
            {
                ...
                return s != null ? GenerateLiteralValue(s) : GenerateLiteralValue((dynamic)value);
            }
            return "NULL";
        }
    }
